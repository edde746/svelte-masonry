...
<div class="wrapper">
  ...
  <p>
    Originally created by <a href="https://github.com/janzheng">janzheng</a>, updated by
    <a href="https://github.com/edde746">edde746</a>
  </p>
  ...
  <div class="sticky">
    <button on:click={() => (itemCount < data.length ? (itemCount += 1) : undefined)}> Add Food! </button>
